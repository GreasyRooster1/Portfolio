...
const LINKS = [{ label: 'writeup', href:"qcode_writeup", accent:true},{ label: 'source', href:"https://github.com/GreasyRooster1/QCode", accent:false},{ label: 'student work', href:"qcode_projects", accent:false}]
