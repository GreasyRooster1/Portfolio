...
export default function WorkCard({ note, imgH, title, year, desc, stats, bar, links, imgSrc ,isVideo, videoSrc}) {
  return (
    <div className={styles.card} >
        {isVideo?
            <video className={styles.image}  height={imgH} poster={imgSrc} autoPlay muted loop>
